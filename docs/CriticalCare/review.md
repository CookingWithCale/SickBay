# [pandemic.cookbook](../).[critical_care](./)

![GitHub Social media icon for the cookbook..](../SocialMediaIcon.png)

## Review

This section is a review of everything covered in this chapter.

**[<< Previous Section: Chapter Overview](./) | [Next Chapter: Non-Critical Care >>](../non-critical_care)**
