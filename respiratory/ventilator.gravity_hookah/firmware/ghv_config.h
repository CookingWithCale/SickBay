...
enum {
    ...
    cMaxPulsesPerCycle = MaxLitersPerCycle * PulsesPerLiter,
    ...
    cPotADCRange = (MaxPotReading - MinPotReading),
    // The seconds between each cycle.
    cCycleTimeSeconds = (int)(HoursBetweenWateringTimes * 60.0f * 60.0f),
};
